-module(gui_v1).
-export([start/0]).
-export([init_handle_click/2, start_handle_click/2, start_sim/8, insert_cells/8, cells_malibox/2]).
...
%%*******************************************************************************************%%
%% gui version 1 - The basic version. Lighter code suitable for thousands of processes	     %%
%%*******************************************************************************************%%
...
start_sim(Cell_size,Input_2, Start_Button, Env, Stats_Frame, Init_Frame, S_Stat_1, S_Stat_2) ->
	...
	display_loop(S_Stat_2, Frame_size,Cell_size, Start_Button, World_Frame, Stats_Frame, Init_Frame, S_Stat_1, BmpGeneral, BmpSeed, BmpLeaf , BmpAntena , BmpRoot,Env, 0).
...
display_loop(S_Stat_2, Frame_size,Cell_size, Start_Button, World_Frame, Stats_Frame, Init_Frame, S_Stat_1, BmpGeneral, BmpSeed, BmpLeaf , BmpAntena , BmpRoot,Env, 0) ->
	...
	display_loop(S_Stat_2, Frame_size,Cell_size, Start_Button, World_Frame, Stats_Frame, Init_Frame, S_Stat_1, BmpGeneral, BmpSeed, BmpLeaf , BmpAntena , BmpRoot,Env, 1);
	
display_loop(S_Stat_2, Frame_size,Cell_size, Start_Button,World_Frame, Stats_Frame, Init_Frame, S_Stat_1, BmpGeneral, BmpSeed, BmpLeaf , BmpAntena , BmpRoot,Env, 1) ->
			
			% Print the updated windows
			Num_of_cells = main_mail_box(Stats_Frame, Init_Frame, S_Stat_1, S_Stat_2, Start_Button, Env, World_Frame,Cell_size, BmpGeneral, BmpSeed, BmpLeaf , BmpAntena , BmpRoot),
			if Num_of_cells == -1 ->
...
main_mail_box(Stats_Frame, Init_Frame,S_Stat_1, S_Stat_2, Start_Button, Env, World_Frame, Cell_size, BmpGeneral, BmpSeed, BmpLeaf , BmpAntena , BmpRoot) ->
	receive
		{kill} -> 		
			wxFrame:destroy(World_Frame),
		...
		{List, Nodes} -> 	
			...
			Num_of_cells = frame_update(List, Env, World_Frame, Cell_size, BmpGeneral, BmpSeed, BmpLeaf , BmpAntena , BmpRoot),		
			Num_of_cells	
		after 900 -> 	
...
frame_update(List,Env, World_Frame, Cell_size, BmpGeneral, BmpSeed, BmpLeaf , BmpAntena , BmpRoot) ->	
