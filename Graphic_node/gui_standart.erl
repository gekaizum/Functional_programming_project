...
%%**********************************************************************************************%%
%% gui_standard - The most suitable for thousands of processes					%%
...
insert_cells(Env,Type,ImageType,Panel,Cell_size,[{{X_axis,Y_axis},{{_EnvOrganic,_EnvEnergy},{Cell_type,_Energy,_Organic,_TTL,_Cells_created,_Wooded}}}|T], Counter, 0, C_DC) ->
	if 
	Type == Cell_type ->
