...
%%/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
seed_cell(Energy,Organic,{X_coordinate,Y_coordinate},ETS_name) -> 
...
seed_cell_loop(Energy,Organic,{X_coordinate,Y_coordinate},ETS_name) -> 
			...
			after ?EVENT_TIME -> 
					if Energy < 3 ->
								%spawn general cell
								cell_manager!{new_type,X_coordinate,Y_coordinate,general,-1},%inform manager to change type in ETS
								spawn(general_cell_funcs,general_cell,[Energy,Organic,0,0,{X_coordinate,Y_coordinate},ETS_name]),
								exit(self());
						true -> 
								...
								if Random>5 -> 
												...
												%spawn general cell
												exit(self());
									true -> seed_cell(Energy-1,Organic,{X_coordinate,Y_coordinate},ETS_name)
								end
					end
			end.
%%/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
